          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-16">
              ...
              <button
                ...
                className="group px-16 py-3 rounded-full bg-transparent border border-[#8f9eb3] text-[#f1f5f9] font-medium hover:brightness-125 transition-all flex items-center justify-center gap-2"
              >
                View Our Work
